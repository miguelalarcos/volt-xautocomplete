...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'book-shop.com'
  config.app_name = 'Book_shop'
  config.mailer.from = 'Book_shop <no-reply@book-shop.com>'
  ...
  #
  config.app_secret = 'ffsm5SCPI852mRjrP6IIwT89wHRKiTVQ48Ue7HAIDmf_8_q0ZNC74OM2XLHvbWMZsVY'
